...
│  │  │                 │  │                 │  │                 │                │ │
│  │  │ • GitHub Events │  │ • Event Filter  │  │ • Grainchain    │                │ │
│  │  │ • Auth Verify   │  │ • Route Logic   │  │ • Async Queue   │                │ │
│  │  │ • Edge Deploy   │  │ • Error Handle  │  │ • Status Track  │                │ │
│  │  └─────────────────┘  └─────────────────┘  └─────────────────┘                │ │
│  └─────────────────────────────────────────────────────────────────────────────────┘ │
│                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────┤
...
- **Purpose**: Edge-based webhook handling and PR event processing
- **Technology**: Cloudflare Workers + FastAPI + Python (uv)
- **Features**:
  - Global edge deployment
  - GitHub webhook processing
  - Grainchain validation triggers
