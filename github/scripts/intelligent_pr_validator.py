...
class IntelligentPRValidator:
    ...
    def _create_ai_validation_prompt(
        ...
        prompt = f"""
# 🔍 Intelligent PR Validation Request
...
- Analyze how changes affect the overall architecture
...
- Functions and classes with structural issues
- Import and dependency problems
- Parameter usage and function call correctness
- Architectural integrity
Provide specific, actionable feedback that helps improve the PR quality.
"""
