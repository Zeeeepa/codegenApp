...
class ConfigManager:
    ...
    def save_config(self, config_file: Optional[Path] = None) -> None:
        ...
        try:
            data = self.global_config.to_dict()
    ...
    def get_setting(self, key: str, default: Any = None) -> Any:
        ...
        Args:
            key: Setting key (supports dot notation, e.g., 'database.host')
        ...
        """
        keys = key.split('.')
        value = asdict(self.global_config)
    ...
    def set_setting(self, key: str, value: Any) -> None:
        ...
        self.global_config = GlobalConfig.from_dict(config_dict)
        
        # Clear cache and notify
        self._clear_cache()
        self._notify_config_change("global", None)
    ...
    def get_config_template(self, component_name: str) -> Dict[str, Any]:
        """
        Get a configuration template for a component
